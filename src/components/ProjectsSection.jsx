...
const projects = [
    {
        ...
        image: "/portfolio/project_screenshots/homiehand_gameplay.png",
    ...
    },
    {
        ...
        image: "/portfolio/project_screenshots/custom_3d_rendering_pipeline_example.png",
    ...
    },
    {
        ...
        image: "/portfolio/project_screenshots/snake_ai_example.png",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map( (project, key) => (
                    <div key={key}
                        ...
                        <div className="h-90 w-full overflow-hidden bg-muted">
